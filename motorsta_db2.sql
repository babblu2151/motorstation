...
CREATE TABLE `crtord_mst` (
  ...
  `crtordm_adrs` text DEFAULT NULL,
...
CREATE TABLE `gnrlenqry_mst` (
  ...
  `gnrlenqrym_addr` text DEFAULT NULL,
...
(1, 'admin', 'f4c2485f4a82236506839ee13a28b7e5', 'a', 'a', NULL, NULL, '2015-09-30 08:00:05', 'admin');
...
CREATE TABLE `prodcat_mst` (
  ...
  `prodcatm_desc` text DEFAULT NULL,
  ...
  `prodcatm_seodesc` text DEFAULT NULL,
  `prodcatm_seokywrd` tinytext DEFAULT NULL,
  `prodcatm_seohonettl` varchar(250) DEFAULT NULL,
  `prodcatm_seohonedesc` text DEFAULT NULL,
  `prodcatm_seohtwottl` varchar(250) DEFAULT NULL,
  `prodcatm_seohtwodesc` text DEFAULT NULL,
...
CREATE TABLE `prodscat_mst` (
  ...
  `prodscatm_desc` text DEFAULT NULL,
  ...
  `prodscatm_seodesc` text DEFAULT NULL,
  `prodscatm_seokywrd` text DEFAULT NULL,
  `prodscatm_seohonettl` varchar(250) DEFAULT NULL,
  `prodscatm_seohonedesc` text DEFAULT NULL,
  `prodscatm_seohtwottl` varchar(250) DEFAULT NULL,
  `prodscatm_seohtwodesc` text DEFAULT NULL,
...
CREATE TABLE `prod_mst` (
  ...
  `prodm_descone` longtext DEFAULT NULL,
  `prodm_desctwo` longtext DEFAULT NULL,
  ...
  `prodm_seodesc` text DEFAULT NULL,
  `prodm_seokywrd` tinytext DEFAULT NULL,
  `prodm_seohonetitle` varchar(250) DEFAULT NULL,
  `prodm_seohonedesc` text DEFAULT NULL,
  `prodm_seohtwotitle` varchar(250) DEFAULT NULL,
  `prodm_seohtwodesc` text DEFAULT NULL,
...
INSERT INTO `prod_mst` (`prodm_id`, `prodm_code`, `prodm_name`, `prodm_descone`, `prodm_desctwo`, `prodm_mrp`, `prodm_op`, `prodm_wt`, `prodm_brndm_id`, `prodm_catthrm_id`, `prodm_typ`, `prodm_seotitle`, `prodm_seodesc`, `prodm_seokywrd`, `prodm_seohonetitle`, `prodm_seohonedesc`, `prodm_seohtwotitle`, `prodm_seohtwodesc`, `prodm_prty`, `prodm_sts`, `prodm_crtdon`, `prodm_crtdby`, `prodm_mdfdon`, `prodm_mdfdby`) VALUES
(8, 'ALNAC 4G', 'ALNAC 4G', '', '', NULL, NULL, NULL, 6, NULL, '1', '', '', '', '', '', '', '', 2, 'a', '2016-08-25 02:17:40', 'admin', NULL, NULL),
(9, 'AMAZER 3G MAXX', 'AMAZER 3G', '', '', NULL, NULL, NULL, 6, NULL, '1', '', '', '', '', '', '', '', 3, 'a', '2016-08-25 02:18:29', 'admin', '2016-08-25 02:20:02', 'admin'),
(10, 'AMAZER 4G LIFE', 'AMAZER 4G LIFE', '', '', NULL, NULL, NULL, 6, NULL, '1', '', '', '', '', '', '', '', 4, 'a', '2016-08-25 02:21:07', 'admin', NULL, NULL),
(7, 'AMAZER XL', 'AMAZER XL', '', '', NULL, NULL, NULL, 6, NULL, '1', '', '', '', '', '', '', '', 1, 'a', '2016-08-25 02:15:30', 'admin', NULL, NULL),
(11, 'B250', 'B250', '', '', NULL, NULL, NULL, 8, NULL, '1', '', '', '', '', '', '', '', 1, 'a', '2016-08-25 02:26:28', 'admin', NULL, NULL),
(12, 'B290', 'B290', '', '', NULL, NULL, NULL, 8, NULL, '1', '', '', '', '', '', '', '', 2, 'a', '2016-08-25 02:27:03', 'admin', NULL, NULL),
(14, 'B390', 'B390', '', '', NULL, NULL, NULL, 8, NULL, '1', '', '', '', '', '', '', '', 4, 'a', '2016-08-25 02:29:06', 'admin', NULL, NULL),
(15, 'EARTH 1', 'EARTH 1', '', '', NULL, NULL, NULL, 3, NULL, '1', '', '', '', '', '', '', '', 1, 'a', '2016-08-25 02:33:25', 'admin', NULL, NULL),
(13, 'EP150', 'EP150', '', '', NULL, NULL, NULL, 8, NULL, '1', '', '', '', '', '', '', '', 3, 'a', '2016-08-25 02:28:14', 'admin', NULL, NULL),
(16, 'GEOLANDER', 'GEOLANDER', '', '', NULL, NULL, NULL, 3, NULL, '1', '', '', '', '', '', '', '', 2, 'a', '2016-08-25 02:34:03', 'admin', NULL, NULL),
(17, 'GEOLANDER SUV', 'GEOLANDER SUV', '', '', NULL, NULL, NULL, 3, NULL, '1', '', '', '', '', '', '', '', 3, 'a', '2016-08-25 02:34:55', 'admin', NULL, NULL),
(22, 'WANDERER', 'WANDERER', '', '', NULL, NULL, NULL, 1, NULL, '1', '', '', '', '', '', '', '', 5, 'a', '2016-08-25 02:42:43', 'admin', NULL, NULL),
(19, 'ZLX', 'ZLX', '', '', NULL, NULL, NULL, 1, NULL, '1', '', '', '', '', '', '', '', 2, 'a', '2016-08-25 02:40:40', 'admin', NULL, NULL),
(20, 'ZV2K', 'ZV2K', '', '', NULL, NULL, NULL, 1, NULL, '1', '', '', '', '', '', '', '', 3, 'a', '2016-08-25 02:41:27', 'admin', NULL, NULL),
(18, 'ZVTS', 'ZVTS', '', '', NULL, NULL, NULL, 1, NULL, '1', '', '', '', '', '', '', '', 1, 'a', '2016-08-25 02:40:06', 'admin', NULL, NULL),
(21, 'ZVTV', 'ZVTV', '', '', NULL, NULL, NULL, 1, NULL, '1', '', '', '', '', '', '', '', 4, 'a', '2016-08-25 02:42:07', 'admin', NULL, NULL);
...
CREATE TABLE `size_mst` (
  ...
  `sizem_seodesc` text DEFAULT NULL,
  `sizem_seokywrd` text DEFAULT NULL,
  `sizem_seohonettl` varchar(250) DEFAULT NULL,
  `sizem_seohonedesc` text DEFAULT NULL,
  `sizem_seohtwottl` varchar(250) DEFAULT NULL,
  `sizem_seohtwodesc` text DEFAULT NULL,
...
CREATE  VIEW `vw_prod_mst`  AS  (select `prod_mst`.`prodm_id` AS `prodm_id`,`prod_mst`.`prodm_code` AS `prodm_code`,`prod_mst`.`prodm_name` AS `prodm_name`,`prod_mst`.`prodm_descone` AS `prodm_descone`,`prod_mst`.`prodm_desctwo` AS `prodm_desctwo`,`prod_mst`.`prodm_mrp` AS `prodm_mrp`,`prod_mst`.`prodm_op` AS `prodm_op`,`prod_mst`.`prodm_wt` AS `prodm_wt`,`prod_mst`.`prodm_brndm_id` AS `prodm_brndm_id`,`prod_mst`.`prodm_catthrm_id` AS `prodm_catthrm_id`,`prod_mst`.`prodm_typ` AS `prodm_typ`,`prod_mst`.`prodm_seotitle` AS `prodm_seotitle`,`prod_mst`.`prodm_seodesc` AS `prodm_seodesc`,`prod_mst`.`prodm_seokywrd` AS `prodm_seokywrd`,`prod_mst`.`prodm_seohonetitle` AS `prodm_seohonetitle`,`prod_mst`.`prodm_seohonedesc` AS `prodm_seohonedesc`,`prod_mst`.`prodm_seohtwotitle` AS `prodm_seohtwotitle`,`prod_mst`.`prodm_seohtwodesc` AS `prodm_seohtwodesc`,`prod_mst`.`prodm_prty` AS `prodm_prty`,`prod_mst`.`prodm_sts` AS `prodm_sts`,`prod_mst`.`prodm_crtdon` AS `prodm_crtdon`,`prod_mst`.`prodm_crtdby` AS `prodm_crtdby`,`prod_mst`.`prodm_mdfdon` AS `prodm_mdfdon`,`prod_mst`.`prodm_mdfdby` AS `prodm_mdfdby`,`brnd_mst`.`brndm_id` AS `brndm_id`,`brnd_mst`.`brndm_name` AS `brndm_name`,`brnd_mst`.`brndm_desc` AS `brndm_desc`,`brnd_mst`.`brndm_img` AS `brndm_img`,`brnd_mst`.`brndm_zmimg` AS `brndm_zmimg`,`brnd_mst`.`brndm_seotitle` AS `brndm_seotitle`,`brnd_mst`.`brndm_seodesc` AS `brndm_seodesc`,`brnd_mst`.`brndm_seokywrd` AS `brndm_seokywrd`,`brnd_mst`.`brndm_seohonetitle` AS `brndm_seohonetitle`,`brnd_mst`.`brndm_seohonedesc` AS `brndm_seohonedesc`,`brnd_mst`.`brndm_seohtwotitle` AS `brndm_seohtwotitle`,`brnd_mst`.`brndm_seohtwodesc` AS `brndm_seohtwodesc`,`brnd_mst`.`brndm_sts` AS `brndm_sts`,`brnd_mst`.`brndm_prty` AS `brndm_prty`,`brnd_mst`.`brndm_crtdon` AS `brndm_crtdon`,`brnd_mst`.`brndm_crtdby` AS `brndm_crtdby`,`brnd_mst`.`brndm_mdfdon` AS `brndm_mdfdon`,`brnd_mst`.`brndm_mdfdby` AS `brndm_mdfdby` from (`prod_mst` join `brnd_mst` on(`prod_mst`.`prodm_brndm_id` = `brnd_mst`.`brndm_id`))) ;
...
--
ALTER TABLE `lgntrck_mst`
  MODIFY `lgntrckm_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=67;
...
--
ALTER TABLE `prodimg_dtl`
  MODIFY `prodimgd_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `prod_mst`
  MODIFY `prodm_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
